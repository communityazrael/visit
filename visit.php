<?php
echo " ~~~~~~ Welcome To Azrael Community ~~~~~\n  ";
echo ' Website: ';
...
$list[] = "https://www.wiki.com/";
$list[] = "http://www.bing.com/";
$list[] = "https://duckduckgo.com/";
$list[] = "https://search.creativecommons.org/";
$list[] = "http://gibiru.com/";
$list[] = "https://archive.org/";
$list[] = "https://www.searchencrypt.com/";
$list[] = "https://yandex.com/";
$list[] = "https://www.startpage.com/";
$list[] = "https://swisscows.com/";
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". Proses Visit- [".$class->jalankan()."\n";
}
?>
